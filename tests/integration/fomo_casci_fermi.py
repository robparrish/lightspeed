...
class FOMO_CASCI_Fermi_Test(unittest.TestCase):

    def test_fomo_casci_fermi(self):

        self.assertTrue(run_fomo_casci_fermi('integration/data/', 'hbdi.xyz', '6-31gss', 'fomo_casci_fermi.data.npz'))

# => FOMO-CASCI-Fermi <= #

def run_fomo_casci_fermi(run_dir, run_xyz, run_basis, ref_npz):
...
if __name__ == "__main__":
    assert(run_fomo_casci_fermi('data/', 'hbdi.xyz', '6-31gss', 'fomo_casci_fermi.data.npz'))
