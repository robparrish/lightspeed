...
std::shared_ptr<Tensor> BlurBox::ldaDensity(
...
std::shared_ptr<Tensor> BlurBox::ldaPotential(
    const std::shared_ptr<ResourceList>& resources,
    const std::shared_ptr<PairList>& pairlist,
    const std::shared_ptr<HashedGrid>& grid,
...
std::shared_ptr<Tensor> BlurBox::ldaGrad(
    const std::shared_ptr<ResourceList>& resources,
    const std::shared_ptr<PairList>& pairlist,
    const std::shared_ptr<Tensor>& D,
    const std::shared_ptr<HashedGrid>& grid,
...
#if 0
std::shared_ptr<Tensor> BlurBox::ldaGradAdv(
    const std::shared_ptr<ResourceList>& resources,
    const std::shared_ptr<PairList>& pairlist,
    const std::shared_ptr<Tensor>& D,
    const std::shared_ptr<HashedGrid>& grid,
