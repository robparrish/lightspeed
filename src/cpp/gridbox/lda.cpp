...
std::shared_ptr<Tensor> GridBox::ldaDensity(
...
std::shared_ptr<Tensor> GridBox::ldaPotential(
    const std::shared_ptr<ResourceList>& resources,
    const std::shared_ptr<PairList>& pairlist,
    const std::shared_ptr<HashedGrid>& grid,
...
std::shared_ptr<Tensor> GridBox::ldaGrad(
    const std::shared_ptr<ResourceList>& resources,
    const std::shared_ptr<PairList>& pairlist,
    const std::shared_ptr<Tensor>& D,
    const std::shared_ptr<HashedGrid>& grid,
    ...
    )
{
    ...
    // Target
    if (!pairlist->is_symmetric()) throw std::runtime_error("GridBox::ldaaGrad: PairList is not symmetric");
...
// TODO
#if 0
std::shared_ptr<Tensor> GridBox::ldaGradAdv(
    const std::shared_ptr<ResourceList>& resources,
    const std::shared_ptr<PairList>& pairlist,
    const std::shared_ptr<Tensor>& D,
    const std::shared_ptr<HashedGrid>& grid,
